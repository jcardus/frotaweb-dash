                ...
                <table class="w-full text-sm text-left text-white table-auto">
                    ...
                    <tr >
                        <td class="px-6" colspan="3">
                            ...
                            <span class="inline-flex items-center rounded-md bg-gray-50 px-2 py-1 text-xs font-medium text-gray-600 ring-1 ring-gray-500/10 ring-inset">{filterValue}</span>
                        </td>
                        <td class="text-right no-print px-6 py-1" colspan="3">
